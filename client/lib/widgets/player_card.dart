        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              if (!player.connected) Text(_s.disconnected, style: const TextStyle(fontSize: 9, color: Colors.orangeAccent)),
              if (!player.alive) Text(_s.eliminated, style: const TextStyle(fontSize: 9, color: Colors.redAccent)),
            ],
          ),
        ),
      ),
